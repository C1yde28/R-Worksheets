---
title: "RWorksheet_Delgado#4b.Rmd"
...
dataset <- read.csv(file.path("C:", "Rworksheets", "worksheet#4", "DATA.csv"), header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
gender_data <- read.csv(file.path("C:", "Rworksheets", "worksheet#4", "DATA.csv"), header = TRUE, sep = ",", stringsAsFactors = FALSE)
